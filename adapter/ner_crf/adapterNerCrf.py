...
class AdapterNerCrf(object):
    ...
    def pass_entity(self,list_entity,user_msg):
        ...
        result['WEATHER'] = ner_crf.get_weather(list_entity)
        sub_loc = ""
    ...
    def convert_time(data):
        ...
        return AdapterNerCrf.fill_time(data_time)
